...
commands and emacslisp. Keys are writted as <kbd>C-a</kbd> for
<kbd>Ctrl</kbd> + <kbd>a</kbd> or <kbd>M-a</kbd> for <kbd>Meta</kbd> (usually <kbd>Alt</kbd>
or <kbd>Opt</kbd> on PC or Mac keyboards.) If there's a space between keys, it means they're
pressed in seqeunce. If they're in the same <kbd>Key</kbd> they're pressed at the
same time, as you would a piano chord, or <kbd>Ctrl</kbd> + <kbd>Alt</kbd> + <kbd>Del</kbd>
