...
| <kbd>F</kbd>  *my-dired-find-file*                     | <kbd>%</kbd> &nbps; <kbd>&amp;</kbd>  *dired-flag-garbage-files*                      |
| <kbd>G</kbd>  *dired-do-chgrp*                         | <kbd>%</kbd> &nbps; <kbd>C</kbd>  *dired-do-copy-regexp*                              |
| <kbd>H</kbd>  *dired-do-hardlink*                      | <kbd>%</kbd> &nbps; <kbd>H</kbd>  *dired-do-hardlink-regexp*                          |
| <kbd>L</kbd>  *dired-do-load*                          | <kbd>%</kbd> &nbps; <kbd>R</kbd>  *dired-do-rename-regexp*                            |
| <kbd>M</kbd>  *dired-do-chmod*                         | <kbd>%</kbd> &nbps; <kbd>S</kbd>  *dired-do-symlink-regexp*                           |
| <kbd>O</kbd>  *dired-do-chown*                         | <kbd>%</kbd> &nbps; <kbd>d</kbd>  *dired-flag-files-regexp*                           |
| <kbd>P</kbd>  *dired-do-print*                         | <kbd>%</kbd> &nbps; <kbd>g</kbd>  *dired-mark-files-containing-regexp*                |
| <kbd>Q</kbd>  *dired-do-query-replace-regexp*          | <kbd>%</kbd> &nbps; <kbd>l</kbd>  *dired-downcase*                                    |
| <kbd>R</kbd>  *dired-do-rename*                        | <kbd>%</kbd> &nbps; <kbd>m</kbd>  *dired-mark-files-regexp*                           |
| <kbd>S</kbd>  *dired-do-symlink*                       | <kbd>%</kbd> &nbps; <kbd>r</kbd>  *dired-do-rename-regexp*                            |
| <kbd>T</kbd>  *dired-do-touch*                         | <kbd>%</kbd> &nbps; <kbd>u</kbd>  *dired-upcase*                                      |
...
| <kbd>t</kbd>  *dired-toggle-marks*                     | <kbd>M-s</kbd> &nbsp <kbd>f</kbd> &nbsp; <kbd>C-s</kbd>  *dired-isearch-filenames*          |
| <kbd>u</kbd>  *dired-unmark*                           | <kbd>M-s</kbd> &nbsp <kbd>a</kbd> &nbsp; <kbd>C-s</kbd>  *dired-do-isearch*                 |
| <kbd>v</kbd>  *dired-view-file*                        | <kbd>M-s</kbd> &nbsp <kbd>f</kbd> &nbsp; <kbd>C-M-s</kbd>  *dired-isearch-filenames-regexp* |
| <kbd>w</kbd>  *dired-copy-filename-as-kill*            | <kbd>M-s</kbd> &nbsp <kbd>a</kbd> &nbsp; <kbd>C-M-s</kbd>  *dired-do-isearch-regex*         |
